...
<td align="center">
<h3 style="margin:0px">
   Treinamentos no Trabalho</h3><hr style="border:dotted 1px #333333" />
</td>
</tr>
<tr>
<td>
...
<td><strong>Departmento</strong></td>
            ...
            <Columns>
                <asp:TemplateField HeaderText="Treinamento no Trabalho">
                    <ItemTemplate>
                        ...
                        <b>Programa : </b><asp:Label ID="lblTraining" runat="server" Text='<%# Eval("TrainingDetails") %>'></asp:Label><br /><br />
                        <b>Efetividade : </b><asp:Label ID="lblTEffectiveness" runat="server" Text='<%# Eval("Effectiveness") %>'></asp:Label><br /><br />
                    </ItemTemplate>
...
<asp:GridView id="gvOffJob" runat="server" Width="100%" GridLines="Both" ForeColor="Black" CellPadding="4" BorderStyle="None" BorderColor="#CCCCCC" AutoGenerateColumns="False" BackColor="White" BorderWidth="1px">
            <Columns>
                <asp:TemplateField HeaderText="Treinamento fora do trabalho">
                    <ItemTemplate>
                        <b>Data : </b><%# getDurationDate(Convert.ToDateTime(Eval("StartDate")), Convert.ToDateTime(Eval("EndDate")))%><br /><br />
                        <b>Programa : </b><asp:Label ID="lblTraining" runat="server" Text='<%# Eval("TrainingDetails") %>'></asp:Label><br /><br />
                        <b>Efetividade : </b><asp:Label ID="lblTEffectiveness" runat="server" Text='<%# Eval("Effectiveness") %>'></asp:Label><br /><br />
