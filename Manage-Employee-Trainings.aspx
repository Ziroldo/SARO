...
<asp:Content ID="cMainContent" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <hr style="border-style:dotted; border-color:#CDCDCD" />
        ...
        <td align="right">
            ...
            <asp:Button ID="btnSave" runat="server" CssClass="buttonBlue" Text="Incluir Treinamentos" style="width:100px" OnClick="btnSave_Click" /></td>
        </tr>
        </table>
        <asp:GridView ID="gvMaster" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="Both" BorderStyle="Solid" BorderColor="#000000" Width="100%" OnRowCommand="gvMaster_RowCommand" OnRowDataBound="gvMaster_RowDataBound" OnRowDeleting="gvMaster_RowDeleting" AllowPaging="True" OnPageIndexChanging="gvMaster_PageIndexChanging" PageSize="15">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Editar">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" ID="lbEdit" Text="Editar" CommandName="Edit" CommandArgument='<%# Eval("TrainingId") %>'></asp:LinkButton>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Deletar">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" ID="lbDelete" Text="Deletar" CommandName="Delete" CommandArgument='<%# Eval("TrainingId") %>'></asp:LinkButton>
                    </ItemTemplate>
                    <ItemStyle Width="50px" HorizontalAlign="Center"  />
                    <HeaderStyle HorizontalAlign="Center" />
                </asp:TemplateField>
