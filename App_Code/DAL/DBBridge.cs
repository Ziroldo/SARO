...
namespace Employee.DAL
{
    ...
    public class DBBridge
    {
        ...
        public static string DBConnection()
        {
            try
            {
                return System.Configuration.ConfigurationManager.ConnectionStrings["ConexaoRecursosHumanos"].ConnectionString;

            }
            catch (Exception ce)
            {

                throw new ApplicationException("Não é possível obter a string de conexão do banco de dados do arquivo de configuração. Entre em contato com o administrador" + ce);
            }
        }
